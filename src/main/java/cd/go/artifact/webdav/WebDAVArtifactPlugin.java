...
import cd.go.artifact.webdav.executors.*;
import cd.go.artifact.webdav.utils.Util;

@Extension
public class WebDAVArtifactPlugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(WebDAVArtifactPlugin.class);
