...
public class Redmine {
  ...
  public static final Gson GSON = new GsonBuilder()
    ...
    public void upload(String workingDir, String sourceFile, String targetFile, ConsoleLogger console) throws IOException {
        AttachmentUpload upload = uploadFile(workingDir, sourceFile, console);
        if (upload == null || upload.upload == null || upload.upload.token == null || upload.upload.token.trim().isEmpty()) {
            ...
            linkUploadToVersion(upload, targetFile, console);
        }
    }

    private AttachmentUpload uploadFile(String workingDir, String sourceFile, ConsoleLogger console) throws IOException {
        ...
        File file = new File(workingDir, sourceFile);
    ...
    private void linkUploadToVersion(AttachmentUpload upload, String targetFile, ConsoleLogger console) throws IOException {
