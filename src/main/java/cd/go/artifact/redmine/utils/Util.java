...
import cd.go.artifact.redmine.annotation.FieldMetadataTypeAdapter;
import cd.go.artifact.redmine.model.ArtifactPlanConfig;
import cd.go.artifact.redmine.model.ArtifactPlanConfigTypeAdapter;
