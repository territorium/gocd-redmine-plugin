...
import cd.go.artifact.redmine.executors.*;
import cd.go.artifact.redmine.utils.Util;

@Extension
public class RedmineArtifactPlugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(RedmineArtifactPlugin.class);
