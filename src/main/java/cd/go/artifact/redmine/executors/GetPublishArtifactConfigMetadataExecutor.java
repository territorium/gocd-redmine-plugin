...
import cd.go.artifact.redmine.model.RedmineFileArtifactPlanConfig;
...
public class GetPublishArtifactConfigMetadataExecutor implements RequestExecutor {
    ...
    public GoPluginApiResponse execute() {
        final List<ConfigMetadata> metadata = MetadataHelper.getMetadata(RedmineFileArtifactPlanConfig.class);
